...
namespace InControl
{
	...
	public class UnitySimultaneousThreeKeyCodeSource : UnitySimultaneousTwoKeyCodeSource
	{
		protected KeyCode keyCode3;
		
		
		public UnitySimultaneousThreeKeyCodeSource( KeyCode keyCode1, KeyCode keyCode2, KeyCode keyCode3 ) : base ( keyCode1, keyCode2 )
		{
	...
	public class UnitySimultaneousFourKeyCodeSource : UnitySimultaneousThreeKeyCodeSource
	{
		protected KeyCode keyCode4;
		
		
		public UnitySimultaneousFourKeyCodeSource( KeyCode keyCode1, KeyCode keyCode2, KeyCode keyCode3, KeyCode keyCode4 ) : base ( keyCode1, keyCode2, keyCode3 )
		{
	...
	public class UnitySimultaneousFiveKeyCodeSource : UnitySimultaneousFourKeyCodeSource
	{
		protected KeyCode keyCode5;
		
		
		public UnitySimultaneousFiveKeyCodeSource( KeyCode keyCode1, KeyCode keyCode2, KeyCode keyCode3, KeyCode keyCode4, KeyCode keyCode5 ) : base ( keyCode1, keyCode2, keyCode3, keyCode4 )
		{
